...
- `Review#viewer`
  - returns the `Viewer` instance associated with the `Review` instance, check
- `Review#movie`
  - returns the `Movie` instance associated with the `Review` instance, check

#### Viewer

- `Viewer#reviews`
  - returns an array of `Review` instances associated with the `Viewer` instance. check
- `Viewer#reviewed_movies`
  - returns an array of `Movie` instances reviewed by the `Viewer` instance. check

#### Movie

- `Movie#reviews`
  - returns an array of all the `Review` instances for the `Movie`. , check
- `Movie#reviewers`
  - returns an array of all of the `Viewer` instances that reviewed the `Movie` check
